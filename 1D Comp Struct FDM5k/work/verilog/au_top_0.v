...
module au_top_0 (
  ...
  wire [1-1:0] M_edge_reset_button_out;
  reg [1-1:0] M_edge_reset_button_in;
  edge_detector_3 edge_reset_button (
    .clk(clk),
    .in(M_edge_reset_button_in),
    .out(M_edge_reset_button_out)
  );
  ...
  button_conditioner_p2_4 p2_button1 (
    .clk(clk),
    .in(M_p2_button1_in),
  ...
  button_conditioner_p2_4 p2_button2 (
    .clk(clk),
    .in(M_p2_button2_in),
  ...
  button_conditioner_p2_4 p2_button3 (
    .clk(clk),
    .in(M_p2_button3_in),
  ...
  button_conditioner_p2_4 p2_button4 (
    .clk(clk),
    .in(M_p2_button4_in),
  ...
  always @* begin
    ...
    M_reset_button_in = ~io_dip[8+1+0-:1];
    M_edge_reset_button_in = M_reset_button_out;
    M_game_beta_reset_button = M_edge_reset_button_out;
