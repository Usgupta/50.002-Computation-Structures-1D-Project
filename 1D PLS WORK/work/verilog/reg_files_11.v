...
module reg_files_11 (
  ...
  reg [15:0] M_p1_invalid_d, M_p1_invalid_q = 1'h0;
  reg [15:0] M_p2_invalid_d, M_p2_invalid_q = 1'h0;
  
  always @* begin
    M_p1_score_d = M_p1_score_q;
    M_p1_invalid_d = M_p1_invalid_q;
    M_light_up_d = M_light_up_q;
    M_p2_col4_d = M_p2_col4_q;
    M_p2_invalid_d = M_p2_invalid_q;
    ...
    case (read_address_a)
      ...
      4'he: begin
        out_a = M_p1_invalid_q;
      end
      4'hf: begin
        out_a = M_p2_invalid_q;
      end
      default: begin
        out_a = 1'h0;
      end
    ...
    case (read_address_b)
      ...
      4'he: begin
        out_b = M_p1_invalid_q;
      end
      4'hf: begin
        out_b = M_p2_invalid_q;
      end
      default: begin
        out_b = 1'h0;
      end
    ...
    data_out = {M_p2_invalid_q, M_p1_invalid_q, M_main_timer_q, M_mini_timer_q, M_p2_col4_q, M_p2_col3_q, M_p2_col2_q, M_p2_col1_q, M_p1_col4_q, M_p1_col3_q, M_p1_col2_q, M_p1_col1_q, M_light_up_q, M_p2_score_q, M_p1_score_q};
  end
  ...
  always @(posedge clk) begin
    if (rst == 1'b1) begin
      ...
      M_p1_invalid_q <= M_p1_invalid_d;
      M_p2_invalid_q <= M_p2_invalid_d;
    end
  end
