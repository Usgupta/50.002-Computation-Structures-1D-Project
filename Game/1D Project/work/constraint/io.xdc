...
set_property PACKAGE_PIN P5 [get_ports {io_seg2[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_seg2[0]}]
set_property PACKAGE_PIN M5 [get_ports {io_seg2[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_seg2[1]}]
set_property PACKAGE_PIN L4 [get_ports {io_seg2[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_seg2[2]}]
set_property PACKAGE_PIN L5 [get_ports {io_seg2[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_seg2[3]}]
set_property PACKAGE_PIN N4 [get_ports {io_seg2[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_seg2[4]}]
set_property PACKAGE_PIN M4 [get_ports {io_seg2[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_seg2[5]}]
set_property PACKAGE_PIN T4 [get_ports {io_seg2[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {io_seg2[6]}]
set_property PACKAGE_PIN R3 [get_ports {io_seg2[7]}]
